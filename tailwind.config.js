...
export default {
  ...
  content: [
    ...
    // Specific paths for shadcn/vue components if they are in standard locations
  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        "accordion-down": {
          from: { height: "0" }, // Changed from 0 to "0" for valid CSS
          to: { height: "var(--radix-accordion-content-height)" },
        },
        "accordion-up": {
          from: { height: "var(--radix-accordion-content-height)" },
          to: { height: "0" }, // Changed from 0 to "0" for valid CSS
        },
      },
      animation: {
